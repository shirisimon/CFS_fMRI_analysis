...
subjects_dir_pattern = '379*';
files_pattern = '*_exp3*.csv';
subjects_dir_depth = '1';
files_dir_depth = '2';

% params 2 prt
output_file_ext = 'msk3_4';
prt_type = 'vol';
convert2Vol = 1;
tr_length = 2;
tr_num = 398;
skip_tr = 325;
lag = 0;
predictors_names = {'low', 'high', 'catch'};
...
for s = 1:length(sub_folders)
    ...
    for r = 1:length(datasets)
        ...
        colors = [ 0 0 0 ; 255 170 0 ; 170 255 255 ; 255 0 255 ; 170 255 127 ; 0 85 255 ; 255 0 0 ; 0 170 0] ;
