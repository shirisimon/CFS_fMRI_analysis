...
def sub_analysis(subs, sub_data_generator):
        for sub in subs:
            ...
            try:
                ...
                a,b,c = clf.best_score_, accuracy_score(y_true_high, y_pred_high), accuracy_score(y_true_low, y_pred_low)
            except:
...
# TODO: try -1, and 0 as baseline time
# TODO: train low and high seperatly
